...
Step | Description
-----|------------
1 Initial Contact | Customer contacts UKCloud to register interest in the CDSZ service. This can be through [My Calls](https://portal.ukcloud.com/support/ivanti) or direct contact with a Sales representative, Technical Account Manager (TAM) or Cloud Architect.
