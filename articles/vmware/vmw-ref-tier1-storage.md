...
Initially, moving a workload to and from the Tier 1 platform will be a manual process that may involve raising a Service Request via [My Calls](https://portal.ukcloud.com/support/ivanti) on the UKCloud Portal.
