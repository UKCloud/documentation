...
Due to restrictions on the characters permitted for virtual machines in the current version of ESXi hosts on the UKCloud platform, you should be aware of the following:
