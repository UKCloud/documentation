...
1. In My Calls, reaise a ticket using the **Managed IT Operations - Make changes to my managed devices** template.
...
3. Fill out the appropriate tabs in the spreadsheet, depending on the configuration chagnes you want to make.
