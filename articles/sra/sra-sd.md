---
title: Secure Remote Access Service Definition | UKCloud Ltd
...
toc_sub3:
toc_sub4:
toc_title: Secure Remote Access Service Definition
toc_fullpath: Service Definition/sra-sd.md
...
This service is priced per licence per calendar month from £5.00, and full pricing with all options including licensing and connectivity available in the [*UKCloud Pricing Guide*](../other/other-ref-pricing-guide.md).
