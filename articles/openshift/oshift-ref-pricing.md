...
UKCloud for Red Hat OpenShift pricing can be as low as 83p per hour (using committed annual pricing option). Full pricing with all options, including licensing and connectivity, is available in the [UKCloud Pricing Guide](https://ukcloud.com/pricing-guide).
