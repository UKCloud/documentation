...
The management of your Oracle estate is split between Oracle Enterprise Manager (OEM) and vCloud Director/VMware Cloud Director:

- Use OEM to build and manage your VMs and templates

- Use vCloud Director/VMware Cloud Director to create your VM networks and configure your edge gateway, including firewall rules and VPN connections
...
Networking and connectivity for UKCloud for Oracle Software is managed within vCloud Director/VMware Cloud Director, which you access through the UKCloud Portal rather than Enterprise Manager Cloud Control.

> [!NOTE]
> Because you create your network in vCloud Director/VMware Cloud Director, you'll see references to VMware terminology, such as organisations and virtual data centres (VDCs). In UKCloud for Oracle Software, an Oracle tenant is equivalent to a VDC.
...
The tools for configuring your edge gateway are provided within vCloud Director/VMware Cloud Director, which you access through the UKCloud Portal rather than Enterprise Manager Cloud Control.
