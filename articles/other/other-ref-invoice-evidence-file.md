...
- **vCloud Snapshot storage** (columns AA, AG and AM) - charges will appear in this column if a VM is manually snapshotted in VMware Cloud Director/vCloud Director. Charges for the storage will not be applied for October, though values may appear in these columns. Billing will commence from November 1 2017.
