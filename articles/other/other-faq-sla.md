...
### How do you monitor the UKCloud for Red Hat OpenShift service?
...
### Can you give me a worked example for UKCloud for Red Hat OpenShift SLA?

Example factors (Assured Public UKCloud for Red Hat OpenShift)
...
- The Service Credit is 3% of the amount billed to that UKCloud for Red Hat OpenShift instance during the calendar month = £223.20
