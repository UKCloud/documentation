...
---
# Retrieving Billing information from the CSP Portal via API
The purpose of this guide is to help obtain Billing information from the CSP Portal via the API.

## Authentication 
Authentication requires obtaining AAD token and then JWT token from the Partner Portal itself, appended to each request.
...
```
The tennit ID can either be:
* Default value for tenant independent keys - common
* The tennent ID, e.g. XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX
* The tennet Domain e.g. example.your.domain.com

### Body

**grant_type**

This is the type of authentication scheme you will be using. In this example the value is:

"password"

**clientid**

This value is unique to your CSP portal e.g.

XXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX

**resource**

The resource the token will be used to access: 
https://api.partnercenter.microsoft.com

**username**

The Azure Stack AAD account email.

**password**

The Azure Stack AAD account password.
...
```
**grant_type:** This is the type of authentication scheme you will be using. In this example the value is:  

**jwt_token:** Which simply means JSON Web Token.
