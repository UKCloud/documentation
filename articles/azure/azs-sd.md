...
UKCloud for Microsoft Azure VMs start at 3p per hour, and full pricing with all options including public Azure, licensing and connectivity available in the [*UKCloud Pricing Guide*](../other/other-ref-pricing-guide.md).
