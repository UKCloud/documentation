...
> [!IMPORTANT]
> If you have conditional access policy enabled for your Azure Active Directory, follow the instructions from the invitation email to allow us access to your AAD.
>
> You can find more information about conditional access policy [here](https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#trusted-ips).
