...
# Log in to your public Azure Subscription you will be creating your SPN on
...
$RoleAssignment = New-AzureRmRoleAssignment -RoleDefinitionName $PublicAzureRole -ServicePrincipalName $AppGet.ApplicationId.Guid
