...
If you have [Docker](https://www.docker.com/) installed on your workstation, Microsoft provides a Azure CLI container which can be used instead of installing dependencies locally.
