...
toc_fullpath: Service Information/vls-sco.md
toc_mdlink: vls-sco.md
---
...
- If the customer wants to use an additional VMware module, they can request a new licence key as per [*How to request a new VLS licence*](vls-how-vls-request-licence.md).
...
Workspace ONE is delivered via a parallel but separate service offering. For more information, see the [*UKCloud VMware Workspace ONE Managed Service Service Scope*](vls-sco-ws1.md).
...
For more information regarding support hours, SLA and escalation, see [*How to raise and escalate support tickets with customer support*](../portal/ptl-ref-raise-escalate-service-request.md).
...
- [VMware Licence Service Service Definition](https://ukcloud.com/app/uploads/2022/08/ukc-svc-226-vmware-licence-service-service-definition-13.0.pdf)

- [*How to install the vCloud Usage Meter for the VMware Licence Service*](vls-how-vls-install-usage-meter-4.md)

- [*How to add products to the vCloud Usage Meter for the VMware Licence Service*](vls-how-vls-add-products-4.md)

- [*How to request a new VLS licence*](vls-how-vls-request-licence.md)
