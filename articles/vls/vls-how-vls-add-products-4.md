...
If a Horizon Connection Server exists behind a load balancer, you must add a Connection Server directly to vCloud Usage Meter, not via a load balanced IP.
